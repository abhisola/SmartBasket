...
const int CS = 16;
const byte sleepTime_hr = 1;// 3 = will sleep at <1uA for 3hrs
const int httpPort = 80; // Host Port 80 if on heroku
String store_id = "1";
String basket_id = "1";
//const int httpPort = 3000; // Local Host
const char* host = "smart-basket-api.herokuapp.com"; // Host Name heroku App Name
//const char* host = "192.168.0.104";
String url = "/smartbasket/api/"+store_id+"/"+basket_id; // /smartbasket/api/StoreId/BasketId
String voltage_url = "/smartbasket/api/battery/"+store_id+"/"+basket_id; // /smartbasket/api/battery/StoreId/BasketId
...
Serial.println(len);
  ...
  Serial.println(postTo);
  http.begin(postTo);
  http.addHeader("Content-Type", "application/json");
  int httpCode = http.POST(voltageData);
