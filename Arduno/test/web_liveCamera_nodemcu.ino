...
//
// This program demonstrates using an ArduCAM Mini 5MP camera with an ESP8266-12E module.
// An OV5642 5MP ArduCAM Mini was used with this program.
//
...
void setup() {
  ...
  myCAM.rdSensorReg16_8(OV5642_CHIPID_LOW, &pid);
   if((vid != 0x56) || (pid != 0x42)){
    Serial.println("Can't find OV5642 module! pid: " + String(pid));
  else
